...
var router = function(app) {
	app.post('/evaluations', function(req, res, next){
		console.log('req.body: ' + JSON.stringify(req.body));
		var res_json = JSON.parse(JSON.stringify(constant.RES));
		var input = req.body;
		input.docType = 'evaluation';
	...
	app.get('/evaluations', function(req, res, next){
		console.log('req.query: ' + JSON.stringify(req.query));
		var selector = req.query;
		selector.docType = 'evaluation';
	...
	app.get('/evaluations/:id', function(req, res, next){
	...
	app.del('/evaluations/:id', function(req, res, next){
		console.log('req.parmas.id: ' + req.params.id);
		var json = {'_id': req.params.id};
		db.get(json).then(function(data){
			var res_json = JSON.parse(JSON.stringify(constant.RES));
